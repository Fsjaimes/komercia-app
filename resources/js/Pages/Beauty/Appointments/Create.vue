...
// Calcula duración y precio total
...
<template>
    <BeautyLayout title="Nueva Cita">
        <div class="p-6 max-w-3xl">
        <h1 class="text-2xl font-bold text-pink-700 mb-6">Agendar Nueva Cita</h1>
        <form @submit.prevent="form.post(route('beauty.appointments.store'))">
            <div class="mb-4">
            ...
            <div v-if="form.services.length === 0" class="text-center py-4 text-gray-500">
                No hay servicios. Haz clic en "Agregar servicio".
            </div>
            </div>
            ...
            <button type="submit" class="bg-pink-600 text-white px-4 py-2 rounded hover:bg-pink-700">Agendar Cita</button>
            <Link :href="route('beauty.appointments.index')" class="bg-gray-200 px-4 py-2 rounded">Cancelar</Link>
            </div>
        </form>
        </div>
    </BeautyLayout>
